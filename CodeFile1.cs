...
namespace Petzold.GradiateTheBrush { 
    public class GradiateTheBrush : Window {
        ...
        public GradiateTheBrush() {
            ...
            LinearGradientBrush brush = new LinearGradientBrush(Colors.Red, Colors.Blue, new Point(0, 0), new Point(1, 1)); //конструктор, позволяющий окрасить левый верхний угол (0,0) в касный цвет, а правый нижний (1,1) в синий и соединить углы градиентской заливкой 
            Background = brush; //2
        } 
    } 
}